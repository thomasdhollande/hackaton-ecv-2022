...
// TESTIMONIALS
const testimonial_card = document.querySelectorAll(".testimonial");

testimonial_card.forEach(element => {
    let state = {
        mouseX: 0,
        mouseY: 0,
        height: element.clientHeight,
...
const avantage_card = document.querySelectorAll(".avantage");

avantage_card.forEach(element => {
    let state = {
        mouseX: 0,
        mouseY: 0,
        height: element.clientHeight,
